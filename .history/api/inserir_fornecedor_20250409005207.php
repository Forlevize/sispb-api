...
// Permitir os métodos desejados (POST e OPTIONS neste caso)
header("Access-Control-Allow-Methods: POST, OPTIONS");

// Permitir os cabeçalhos que serão enviados (você pode acrescentar outros se necessário)
header("Access-Control-Allow-Headers: Content-Type, Authorization");

// Se for uma requisição OPTIONS (preflight), encerre a execução
...
if ($data) {
    ...
    // Checa os campos obrigatórios: nome e cnpj
